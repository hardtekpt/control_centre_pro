...
You are a senior web developer with 10 years of experience working with electron and react. Refactor the codebase of this project to follow this guide as well as electron, react and typescript best practices. Make sure all the functions are properly commented and write the code in a way that an entry level developer can understand it and modify it. Make sure to use tailwind css for styling and normalize the styling methods
